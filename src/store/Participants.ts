...
export const participants: Participant[] = [
  {name: 'Merike Saar', role: 'Juhendaja'},
  {name: 'Anu Tammeleht', role: 'Juhendaja'},
  {name: 'Laivi Hallasoo', role: 'Infoteadus'},
  {name: 'Meelika Kiil', role: 'Eesti filoloogia'},
  {name: 'Kristi Malk', role: 'Tervisejuhtimine'},
